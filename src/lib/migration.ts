...
export function parseCsvToRows(csvText: string): { headers: string[]; rows: Record<string, string>[] } {
...
export function generateCsvTemplate(operationType: ImportOperationType): string {
