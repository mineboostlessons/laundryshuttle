import type { FeaturesBlock, FeatureIcon } from "@/types/blocks";

function FeatureIconSvg({ icon }: { icon: FeatureIcon }) {
  const className = "h-8 w-8 text-primary";
  ...
  switch (icon) {
    ...
    case "map":
      return (
        <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m0 0-3 3m3-3 3 3m-3-3V6.75m6 0V15m0 0 3 3m-3-3-3 3" />
        </svg>
      );
    case "calendar":
      return (
